...
import { getAllUserIds, getParticipantsByAuthor } from "./useConversationsParticipants.utils";
...
export const useConversationsParticipants = (conversationIds?: string[]) => {
  ...
  const practitionersAndTenantAdminData = client.getQueryData<Record<string, User> | undefined>([
  ...
  return useQuery(
    ...
    () => fetchConversationsParticipants(conversationIds, practitionersAndTenantAdminData),
    {
