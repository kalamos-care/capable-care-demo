...
export class PaymentIntentApi {
   ...
   * @callback moduleapi/PaymentIntentApi~paymentIntentsPostCallback
   ...
   * @param {module:model/PaymentIntentsBody} opts.body
   * @param {module:api/PaymentIntentApi~paymentIntentsPostCallback} callback The callback function, accepting three arguments: error, data, response
   */
  paymentIntentsPost(opts, callback) {
    opts = opts || {};
