...
/**
 * PatientPrescriptions service.
 * @module api/PatientPrescriptionsApi
 * @version v0.3
 */
export class PatientPrescriptionsApi {
  /**
    * Constructs a new PatientPrescriptionsApi. 
    * @alias module:api/PatientPrescriptionsApi
    * @class
   ...
   * @callback moduleapi/PatientPrescriptionsApi~prescriptionsGetCallback
   ...
   * @param {module:api/PatientPrescriptionsApi~prescriptionsGetCallback} callback The callback function, accepting three arguments: error, data, response
   */
